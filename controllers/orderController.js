...
async function createOrder() {
  ...
  const order = new WorkOrder({
    type: "Maintenance",
    adminId: "64fdec7a5b9345f2a9b8d7b4", // Replace with actual admin ID
    items: [
      {
        type: "Vehicle",
        itemId: "64fdea2a3b42d3e45a8b5c2d", // Replace with actual vehicle ID
        description: "Oil change required",
      },
      {
        type: "Equipment",
        itemId: "64fdeab6f3245a9b6d7e5f3c", // Replace with actual equipment ID
        description: "Replace worn-out belt",
      },
    ],
    description: "Urgent maintenance required for listed items",
    priority: "High",
  });
